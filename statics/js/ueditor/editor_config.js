...
(function () {
    ...
    URL = editorURL+"statics/js/ueditor/"
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,catcherUrl:editorURL +"index.php?a=getRemoteImage&m=Ueditor&g=Attachment"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:editorURL+"index.php?a=imageManager&m=Ueditor&g=Attachment"         //图片在线管理的处理地址
        ...
        //获取视频数据的地址
        ,getMovieUrl:editorURL+"index.php?a=getMovie&m=Ueditor&g=Attachment"                   //视频数据获取地址
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion','scrawl', 'insertvideo','music','attachments', 'map', 'gmap', 'insertframe','highlightcode','webapp','pagebreak','template','background', '|',
