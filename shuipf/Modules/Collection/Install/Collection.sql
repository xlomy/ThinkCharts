-- ----------------------------
-- Table structure for `shuipfcms_collection_content`
-- ----------------------------
DROP TABLE IF EXISTS `shuipfcms_collection_content`;
CREATE TABLE `shuipfcms_collection_content` (
...
-- ----------------------------
-- Table structure for `shuipfcms_collection_history`
-- ----------------------------
DROP TABLE IF EXISTS `shuipfcms_collection_history`;
CREATE TABLE `shuipfcms_collection_history` (
...
-- ----------------------------
-- Table structure for `shuipfcms_collection_node`
-- ----------------------------
DROP TABLE IF EXISTS `shuipfcms_collection_node`;
CREATE TABLE IF NOT EXISTS `shuipfcms_collection_node` (
...
-- ----------------------------
-- Table structure for `shuipfcms_collection_program`
-- ----------------------------
DROP TABLE IF EXISTS `shuipfcms_collection_program`;
CREATE TABLE `shuipfcms_collection_program` (
  `id` int(10) unsigned NOT NULL auto_increment,
