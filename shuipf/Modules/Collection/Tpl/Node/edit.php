...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" action="{:U('Node/edit')}" method="post" class="J_ajaxForm">
      ...
      <div class="table_full">
        ...
        <table width="100%">
          <tr>
            ...
            <td><input type="text" name="data[name]" id="name"  class="input" value="{$data[name]}" /></td>
          </tr>
          <tr>
        ...
        <table width="100%" class="table_form">
          ...
          <tr>
            ...
            <td> 从
              <textarea rows="10" cols="40" name="data[url_start]">{$data[url_start]}</textarea>
              到
              <textarea rows="10" name="data[url_end]" cols="40">{$data[url_end]}</textarea>
              结束 <br/>
              <span class="gray"> （通过限定采集网址的开始和结束点，更进一步对要采集的网址缩小范围。）</span></td>
          </tr>
          <tr>
            <th width="120">网址：</th>
            <td> <textarea rows="10" cols="40" name="data[url_regular]"  id="url_regular">{$data[url_regular]}</textarea>
            <br />
              ...
              <tbody id="customize_config_{$key}">
                ...
                <tr>
                  ...
                  <td><textarea rows="5" cols="40" name="customize_config[rule][{$key}]" id="rule_0">{$vo.rule}</textarea>
                    <br>
                    使用"<a href="javascript:insertText('rule_0', '[内容]')">[内容]</a>"作为通配符</td>
                  <th width="120">过滤选项：</th>
